...
from src.services import osrm_cost_matrix

OSRM_CALL_PATH = "src.services.compute_cost.osrm_cost.requests.get"
...
def test_osrm_distance_valid_call():
    ...
    cost_matrix = osrm_cost_matrix(sources=sources, destinations=sources)
...
def test_osrm_distance_invalid_call():
    ...
    with pytest.raises(HTTPError):
        osrm_cost_matrix(sources=sources, destinations=sources)
